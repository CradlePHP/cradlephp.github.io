...
menu:
  binder: 6.2.1. Binder (1)
  condition: 6.2.2. Conditional (1)
  loop: 6.2.3. Loop (1)
  instance: 6.2.4. Instance (1)
  singleton: 6.2.5. Singleton (1)
---
# Helper Traits

 - [6.2.1. Binder (1)](#binder)
 - [6.2.2. Conditional (1)](#condition)
 - [6.2.3. Loop (1)](#loop)
 - [6.2.4. Instance (1)](#instance)
 - [6.2.5. Singleton (1)](#singleton)
